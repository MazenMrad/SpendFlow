  ...
  return (
    <header className="flex items-center justify-between px-16 py-6 bg-white border-b border-gray-100">
      ...
      <div className="flex items-center gap-4">
        <a href="/login" className="px-6 py-2 text-sm font-normal text-[#070f18] font-gilroy">
          Sign In
        </a>
        <a href="/register" className="px-6 py-2 text-sm font-normal text-white bg-[#1570ef] rounded-full hover:bg-blue-700 font-gilroy">
          Sign Up
        </a>
      </div>
    </header>
