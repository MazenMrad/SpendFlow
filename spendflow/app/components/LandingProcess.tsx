...
import Line2 from "@/app/icons/landingpageicons/Line 2.svg";
...
export default function LandingProcess() {
  return (
    <section className="bg-[#050d35] py-24 px-16 relative overflow-hidden">
      ...
      <Vector121 className="absolute top-[10%] left-0 w-[500px] h-auto opacity-20 pointer-events-none" />
