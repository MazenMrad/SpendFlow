# tesseract.js/docs/local-installation.md at master · naptha/tesseract.js · GitHub

> Source: https://github.com/naptha/tesseract.js/blob/master/docs/local-installation.md
> Cached: 2026-04-07T21:08:18.545Z
...
[](#local-installation)
Check here for examples: [https://github.com/naptha/tesseract.js/blob/master/docs/examples.md](https://github.com/naptha/tesseract.js/blob/master/docs/examples.md)
...
[](#corepath)
A string specifying the location of the [tesseract.js-core](https://github.com/naptha/tesseract.js-core) files, with default value '[https://cdn.jsdelivr.net/npm/tesseract.js-core@v5.0.0](https://cdn.jsdelivr.net/npm/tesseract.js-core@v5.0.0)'.
