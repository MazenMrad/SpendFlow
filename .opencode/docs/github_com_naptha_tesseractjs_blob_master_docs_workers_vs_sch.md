# tesseract.js/docs/workers_vs_schedulers.md at master · naptha/tesseract.js · GitHub

> Source: https://github.com/naptha/tesseract.js/blob/master/docs/workers_vs_schedulers.md
> Cached: 2026-04-07T21:08:19.396Z
...
Workers can be prepared ahead of time

- E.g. a worker can be created when the page is first loaded, rather than waiting for a user to upload an image to recognize

Workers can be reused for multiple recognition jobs, rather than creating a new worker and loading language data for every image recognized
...
[](#reusing-workers-in-nodejs-server-code)
