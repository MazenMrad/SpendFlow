...
import InvoiceUpload, { OcrExtractedData } from '@/components/ui/invoice-upload';
...
export default function AddExpense() {
  ...
  /** Called when OCR extraction completes - auto-fills form fields */
  ...
  /** Called when receipt image is uploaded successfully */
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (receiptUrl) {
      formDataObj.append('receiptUrl', receiptUrl);
    }
    if (ocrRawText) {
      formDataObj.append('ocrRawText', ocrRawText);
    }
        ...
        <div className="relative bg-white rounded-[20px] lg:rounded-[39px] shadow-[0_4px_20px_0_rgba(0,0,0,0.25),0_5px_10px_0_#F1F2FA]">
          <div className="p-6 lg:p-[50px] relative z-10">
            ...
            <form onSubmit={handleSubmit}>
              {/* OCR Invoice Upload Section */}
              <div className="mb-8 lg:mb-[50px]">
                <h3 className="text-text-primary font-gilroy-medium text-xl mb-4">
                  Scan Invoice
                </h3>
                <p className="text-text-secondary font-gilroy text-sm mb-4">
                  Upload an invoice image to automatically extract amount, date, and description.
                </p>
                <InvoiceUpload
              ...
              {/* Divider */}
              <div className="border-t border-border-light mb-8 lg:mb-[50px]" />
